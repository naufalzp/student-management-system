<form wire:submit="save">
    <div class="shadow rounded-md sm:overflow-hidden">
        <div class="py-6 px-4 bg-white dark:bg-gray-800 ">
            <div class="mb-5">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="email" class="block text-sm font-medium text-gray-800 dark:text-gray-200">Email
                        Address</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input wire:model.blur="form.image" type="file" id="image"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <select wire:model.blur="form.section_id" id="section_id"
                        class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="px-4 py-3 text-right sm:px-6 bg-white dark:bg-gray-800 ">
